		...
		<div class="container">
			<h3>Adding Document Revision</h3>
				...
				<form action="upload.php" method="POST"  enctype="multipart/form-data">
					...
					<input type="hidden" name="tnum" value="<?php echo $trackingno; ?>">
					<button type="submit" name="submit">Upload File</button>
				</form>

				<!-- button that directs to search page if user wants to search anotehr file -->

				<form action = "<?php echo $_SERVER['PHP_SELF'];?>" method = "post">
					<div class="btn-group">
					<button><a href="addrevision.php">Search Another File</a></button>
					</div>
					</form>
		</div>
	</body>
