<html>
	...
	<body>
		...
		<div class="container">
			<h3>Input Chancellor's Decision</h3>
			<div class="row" style="text-align: center;">
				<br><form action="newagenda.php" method="post" id="getform">
					<h4>Priority Level: <select name='level' style='height: 30px;'>
							<option value="Low">Low Priority</option>
							<option value="Medium">Medium Priority</option>
							<option value="High">High Priority</option>
						</select></p>
						Event Date: <input type="date" name="eventdate" size="20" maxlength="30"></p>
						Event Name: <input type="text" name="eventname" size="45"></p></h4>
				</form>
			</div>
			<br><button type="submit" form="getform" class="btn btn-primary" value="Submit" style="margin: auto; display: block;">Add to Agenda</button>
		</div>
	</body>
</html>
