...
<?php
    ...
    $tracking=$_SESSION['doctn'];
    
    $query = mysqli_query($dbc, "SELECT * FROM documents WHERE trackingNumber='$tracking'");
        ...
        else
    {
		...
		<thead>
			<tr>
				...
				<th style="text-align: center;"><b>Title</th>
				...
				<th style="text-align: center;">Submission Final Copy</th>
        ...
        while ($row = mysqli_fetch_array($query))
        {
            ...
            <td>{$summary}</td>
            <td>{$remarks}</td>
			<td style='text-align: center;'>{$processtype}</td>
            <td style='text-align: center;'>{$approvedate}</td>
            <td style='text-align: center;'>{$finalsubdate}</td>
			<td>{$finalcomment}</td>
