...
$output = '';
    ...
    if (ISSET($_GET['tracking_no'])){
		...
		$query = "SELECT * FROM documents WHERE trackingNumber LIKE '%".$_GET['tracking_no']."%' AND  store_safe='1'";
		$result = mysqli_query($dbc,$query);
		$_SESSION['trackingno'] = $_GET['tracking_no'];
	}
...
?>
			...
			<div class="btn-group">
			<a href="addrevision.php"><button>Search Another File</button></a>
			<a href="uploadrevision.php"><button>Upload Revision</button></a>
			<a href="comments.php"><button>Manually comment</button></a>
			</div>
			<br>
		</div>
	</body>
