<html>
	<head>
		<title>TRACK.IO | Revisions</title>
		<meta charset="utf-8">
	...
	<body>
		...
		<div class="container">
			<h3>Adding Document Revision</h3>
				<div class="row">
					<div class="col-sm-4">
						<form action="<?php $_SERVER['PHP_SELF'] ?>" method="post">
							<p>Search: &nbsp <input type="text" name="search" placeholder="Search Document" value = "<?php if (isset($_POST['search'])) echo $_POST['search']; ?>" style="padding: 4px;"> <input type="submit" class="btn btn-primary" value="Enter">
						</form>
					</div>
					<div class="col-sm-8">
<?php 
...
if (isset($_POST['search'])) {
	...
	if ($count == 0) {
        echo "<script type='text/javascript'>alert('You have  inputted an incorrect value. Please try again.')</script>";
       ...
       <th style="text-align: center;">Starting Date</th>
        ...
        while ($row = mysqli_fetch_array($query))
        {
            ...
            <td><a href=addrevisionpage2.php?tracking_no=".$tracking.">{$title}</a></td>
            <td>{$type}</td>
