	...
	<body>
		...
		<div class="container">
			...
			<div class="row" style="text-align: center;">
				<br><form action="viewofficeperformancereport.php" method="post" id="getform">
					<h4>Office Name: <select name='officeid' style='height: 30px;'>
						<?php 
							$query = "SELECT officeCode, name FROM office;";	
							$result = mysqli_query($dbc, $query);
							
							while ($row = $result->fetch_assoc()) 
							{
								echo "<option value=".$row['officeCode'].">".$row['name']."</option>";
							} 
						?> </select></p>
						Starting Date: <input type="date" name="startdate" size="20" maxlength="30"> &nbsp
						Ending Date: <input type="date" name="enddate" size="20" maxlength="30"></p></h4>
				</form>
			</div>
			<br><button type="submit" form="getform" class="btn btn-primary" value="Submit" style="margin: auto; display: block;">Generate Report</button>
		</div>
	</body>
</html>
